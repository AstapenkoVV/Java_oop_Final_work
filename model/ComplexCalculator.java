...
public class ComplexCalculator implements Calculable{
    ...
    public Calculable multi(ComplexNumber arg) {
        double real = primaryArg.getReal() * arg.getReal() -
                primaryArg.getImaginary() * arg.getImaginary();
        double imaginary = primaryArg.getReal() * arg.getImaginary() +
                primaryArg.getImaginary() * arg.getReal();
    ...
    public Calculable div(ComplexNumber arg) {
        ...
        double imaginary = (primaryArg.getImaginary() * arg.getReal() -
                primaryArg.getReal() * arg.getImaginary()) /
                (Math.pow(arg.getReal(), 2) + Math.pow(arg.getImaginary(), 2));
        primaryArg = new ComplexNumber(real, imaginary);
        return this;
    }
